...
import torch
import torch.nn as nn # есть удобные методы для работы со сверточными сетями
from torch import optim # оптимизатор градиентоного спуска
from torch.utils.data import DataLoader # крутая штука для работы с данными
from torch.utils.tensorboard import SummaryWriter # запись данных 
import warnings
warnings.filterwarnings('ignore')
from SCINet.data_process.etth_data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom, Dataset_Pred
from SCINet.experiments.exp_basic import Exp_Basic
...
from SCINet.models.SCINet_decompose import SCINet_decompose
...
class Exp_ETTh(Exp_Basic):
    ...
    def _build_model(self):
        ...
        # создаем экземпляр класса SCINet/SCINet_decompose с нашими входными данными
    ...
    # функция получения данных работает с модулем etth_data_loader в котором берем данные и разбиваем
    ...
    def predict(self, setting):
        ...
        return preds, trues, true_scales, pred_scales
